...
diarization_pipeline = Pipeline.from_pretrained(
    "pyannote/speaker-diarization-3.1", use_auth_token="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",cache_dir="./speaker-diarization"
)
...
#    # , device=device
# )
response = pipeline("/Users/mac/Downloads/source/000012.mp3")
